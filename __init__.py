...
from .api import team_namespace, admin_namespace, AdminContainers
...
def load(app):
    ...
    CTFd_API_v1.add_namespace(team_namespace, path="/plugins/ctfd-whale")
    ...
    def auto_clean_container():
        with app.app_context():
            ...
            for r in results:
                ControlUtil.try_remove_container(r.team_id, r.challenge_id)
