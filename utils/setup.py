...
def setup_default_configs():
    ...
    db.session.add(WhaleRedirectTemplate(
        ...
        '''
[http_{{ container.team_id|string }}-{{ container.uuid }}]
type = http
local_ip = {{ container.team_id|string }}-{{ container.uuid }}
...
'''
    ...
    db.session.add(WhaleRedirectTemplate(
        ...
        '''
[direct_{{ container.team_id|string }}-{{ container.uuid }}]
type = tcp
local_ip = {{ container.team_id|string }}-{{ container.uuid }}
local_port = {{ container.challenge.redirect_port }}
...
[direct_{{ container.team_id|string }}-{{ container.uuid }}_udp]
type = udp
local_ip = {{ container.team_id|string }}-{{ container.uuid }}
local_port = {{ container.challenge.redirect_port }}
remote_port = {{ container.port }}
...
'''
    ...
    db.session.add(WhaleRedirectTemplate(
        ...
        '''
[direct-http_{{ container.team_id|string }}-{{ container.uuid }}]
type = tcp
local_ip = {{ container.team_id|string }}-{{ container.uuid }}
local_port = {{ container.challenge.redirect_port }}
remote_port = {{ container.port }}
...
[direct-http_{{ container.team_id|string }}-{{ container.uuid }}_udp]
type = udp
local_ip = {{ container.team_id|string }}-{{ container.uuid }}
local_port = {{ container.challenge.redirect_port }}
remote_port = {{ container.port }}
